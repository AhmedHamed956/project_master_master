class SuggestionHomeProductModel {
  String? status;
  String? message;
  List<SuggestionHomeProductModelData>? data;

  SuggestionHomeProductModel({this.status, this.message, this.data});

  SuggestionHomeProductModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <SuggestionHomeProductModelData>[];
      json['data'].forEach((v) {
        data!.add(new SuggestionHomeProductModelData.fromJson(v));
      });
    }
  }
...
class SuggestionHomeProductModelData {
  int? id;
  int? subCategoryId;
  int? shopId;
  String? price;
  ...
  SuggestionHomeProductModelData(
      {this.id,
      this.subCategoryId,
      this.shopId,
      this.price,
  ...
  SuggestionHomeProductModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
